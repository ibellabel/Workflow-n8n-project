...
export function LoginForm({ onSubmit }: LoginFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="email" className="block text-sm mb-2" style={{ color: "#0F172A", fontWeight: 500 }}>
          Correo electrónico
        </label>
        <input
          id="email"
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <label htmlFor="password" className="block text-sm" style={{ color: "#0F172A", fontWeight: 500 }}>
            Contraseña
          </label>
          <a href="#" className="text-sm hover:underline" style={{ color: "#1A4FBD", fontWeight: 500 }}>
